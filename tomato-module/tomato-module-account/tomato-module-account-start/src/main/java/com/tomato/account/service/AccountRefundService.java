...
/**
 * 账户退款 1. 退款直接退入风险外金额 2. 是否存在风内金额出款的操作 TODO
 *
 * @author lizhifu
 * @since 2023/1/11
 */
...
public class AccountRefundService {
	...
	public AccountRefundService(AccountHisDao accountHisDao, AccountHisManager accountHisManager,
	...
	public void settleRefund(AccountRefundBO accountRefundBO) {
		...
		AccountHisEntity accountHisEntity = accountHisDao.selectBySysNo(accountRefundBO.getMerchantNo(),
				accountRefundBO.getOrgThirdNo());
		// 原账户历史不存在，此时存在风险
