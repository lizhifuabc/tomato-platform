...
public interface AccountSettleControlDao {
	 ...
	 * @return 数量
	 */
	int updateSettleControl(@Param("id") Long id, @Param("nextSettleDate") LocalDate nextSettleDate,
			@Param("settleRecordId") Long settleRecordId, @Param("version") Integer version);
