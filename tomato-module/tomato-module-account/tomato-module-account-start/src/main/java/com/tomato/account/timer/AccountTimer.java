...
public class AccountTimer {
    ...
    public AccountTimer(AccountInfoDao accountInfoDao, AccountOutReserveBalanceService accountOutReserveBalanceService, AccountDailyCollectService accountDailyCollectService) {
