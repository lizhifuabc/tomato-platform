 ...
 */
@Component
public class EntityVelocityServiceImpl implements VelocityService {

	private final GenConfig genConfig;

	private final GenFieldTypeService genFieldTypeService;

	public EntityVelocityServiceImpl(GenConfig genConfig, GenFieldTypeService genFieldTypeService) {
	...
	public String getTemplate() {
		return TemplateConstant.VM_ENTITY;
	}
