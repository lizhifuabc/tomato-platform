...
public class AuthProperties {
	...
	/**
	 * 设置登录页面中用户名字段名称 – #usernameParameter 缺省值 : username
	 */
	private String usernameParameter = UsernamePasswordAuthenticationFilter.SPRING_SECURITY_FORM_USERNAME_KEY;

	/**
	 * 设置登录页面中密码字段名称 – #passwordParameter 缺省值 : password
	 */
	private String passwordParameter = UsernamePasswordAuthenticationFilter.SPRING_SECURITY_FORM_PASSWORD_KEY;

	/**
	 * 设置登录页面中“记住我”的参数名称 – #rememberMeParameter 缺省值 : remember-me
	 */
	...
	/**
	 * 设置登录失败跳转页面URL – #failureForwardUrl 缺省值 :本机地址:端口号/login?error
	 */
	private String failureForwardUrl;

	/**
	 * 设置登录成功跳转页面URL – #successForwardUrl TODO 不能使用网络地址，否则会报错
	 */
