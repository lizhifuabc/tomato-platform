 ...
 * 认证授权服务器配置
 * <p>
 * 权限处理 {@link AuthorizationManager}
 * 授权模式 {@link ProviderManager}
 * @author lizhifu
 * @since 2023/5/3
 */
...
public class AuthorizationServerConfig {
    /**
     * 认证授权服务器过滤器链
     * OAuth2授权服务器专门处理OAuth2客户端的授权请求流程，授权端点、Token端点、用户信息端点等等都需要对应的过滤器支持。
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(
            HttpSecurity httpSecurity,RegisteredClientRepository registeredClientRepository,
            AuthProperties authProperties,AuthorizationServerSettings authorizationServerSettings
    ) throws Exception {
        log.info("认证服务器配置");
        // 对httpSecurity进行默认配置
    ...
    /**
     * 授权状态信息持久化
     * 资源拥有者的OAuth2授权状态信息 OAuth2Authorization 持久化管理
     * @param jdbcTemplate 数据源
     * @param registeredClientRepository 注册客户端持久化
