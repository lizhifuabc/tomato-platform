...
public class NoticeMqDelayConfig {
	...
	public Binding bindingOrderDelay() {
		return new Binding(RabbitMqConstant.NOTICE_DELAY_QUEUE, Binding.DestinationType.QUEUE,
				RabbitMqConstant.NOTICE_DELAY_EXCHANGE, RabbitMqConstant.NOTICE_DELAY_ROUTING_KEY, null);
	}
