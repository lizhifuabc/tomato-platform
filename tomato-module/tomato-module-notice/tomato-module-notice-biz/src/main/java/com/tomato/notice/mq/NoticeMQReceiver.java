...
public class NoticeMQReceiver {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = RabbitMqConstant.PAY_RESULT_NOTICE_QUEUE),
            exchange = @Exchange(value = RabbitMqConstant.PAY_RESULT_EXCHANGE, type = "fanout")),
            ackMode = "MANUAL"
    )
    public void receiver(@Payload Map<String,String> body,Message message, Channel channel, @Headers Map<String, Object> headers) throws IOException {
