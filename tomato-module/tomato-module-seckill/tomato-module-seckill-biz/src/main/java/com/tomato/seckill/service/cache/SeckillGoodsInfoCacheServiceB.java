...
public class SeckillGoodsInfoCacheServiceB {
	...
	public SeckillGoodsInfoCacheServiceB(RemoteGoodsService remoteGoodsService, SeckillGoodsDao seckillGoodsDao,
	...
	/**
	 * 缓存 秒杀的数据量不大，可以直接缓存到redis中 TODO 优化：秒杀的数据量大的时候，mongoDB,es 等等
