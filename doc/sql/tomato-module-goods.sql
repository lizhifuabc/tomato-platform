...
create table `t_skill_goods`  (
    ...
    `skill_remaining`       int not null  comment '秒杀剩余量',
    `skill_limit`           int not null  default 1 comment '每人限购数量',
...
create table `t_skill_user` (
    ...
    `create_time` datetime not null default current_timestamp comment '创建时间',
    primary key (`id`),
    unique key `unique_activity_relation_id` (`user_id`,`skill_goods_id`)
