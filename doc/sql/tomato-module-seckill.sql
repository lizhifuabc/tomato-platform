...
create table `t_seckill_info`  (
    `name`                  varchar(64) character set utf8mb4 not null comment '活动名称',
...
create table `t_seckill_goods`  (
    `seckill_info_id`         bigint(20) not null comment '活动id',
    ...
    `create_time` datetime not null default current_timestamp comment '创建时间',
    primary key (`id`),
    unique key uk_seckill_info_id_goods_id(`seckill_info_id`,`goods_id`)
...
create table `t_seckill_user` (
    ...
    `create_time` datetime not null default current_timestamp comment '创建时间',
    primary key (`id`),
    unique key `unique_info_relation_id` (`user_id`,`seckill_goods_id`)
