 ...
 * @since 2023/4/26
 */
public interface BaseReadableController<E extends AbstractEntity, ID extends Serializable> extends BaseController {
	 ...
	 * @return 分页数据
	 */
	default Resp<Map<String, Object>> findByPage(Integer pageNumber, Integer pageSize, Sort.Direction direction,
			String... properties) {
