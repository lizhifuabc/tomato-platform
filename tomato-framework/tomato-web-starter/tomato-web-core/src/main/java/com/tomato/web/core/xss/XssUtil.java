...
public class XssUtil {
	...
	private final String nbsp = cleanHtml("&nbsp;");
	private final String quot = cleanHtml("\"");
	...
	public String cleaning(String taintedHTML) {
		...
		String temp = cleanHtml.replaceAll(nbsp, "");
	...
	private String cleanHtml(String taintedHtml) {
		try {
			// AntiSamy 清洗数据
            assert antiSamy != null;
            final CleanResults cleanResults = antiSamy.scan(taintedHtml);
