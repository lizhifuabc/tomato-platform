...
/**
 * multipart/form-data 请求头 当为GET请求时,入参对象或者单属性均可与传入的name键值对一一对应 当为POST请求时,浏览器把form数据封装到http
 * body中,不可用@RequestBody注解修饰接收实体.
 *
 * @author lizhifu
 * @date 2021/9/15
 */
...
public class FormController {
	...
	/**
	 * GET请求 传参没有注解修饰 也可用 @RequestParam 取别名
	 * @param demo
	 * @return
	 */
	...
	/**
	 * POST请求 传参没有注解修饰 传入Body里,参数名为入参的属性名称,文件传输可分开指定字段,也可直接在实体中定义.
	 * @param demo
	 * @param files
	 * @return
	 */
