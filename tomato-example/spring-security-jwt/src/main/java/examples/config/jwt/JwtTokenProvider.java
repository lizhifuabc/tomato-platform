package examples.config.jwt;

import examples.config.InvalidJwtAuthenticationException;
import examples.config.SecurityUserDetails;
...
public class JwtTokenProvider {
	...
	public Authentication getAuthentication(String token) {
		...
		SecurityUserDetails userDetails = new SecurityUserDetails(claims.getSubject(),
				claims.get("nickname", String.class), "", claims.get("roles", List.class), true, true, true, true);
