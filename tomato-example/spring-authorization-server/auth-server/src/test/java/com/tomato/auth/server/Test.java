...
/**
 * TODO 1. REDIRECT_URI,使用错误的地址 2. scope 为demo,数据库为demo 3. scope 为openid,数据库为demo 4. scope
 * 为openid,数据库为openid 5. scope 为空 TODO 1 lb方式调用授权服务，需要配置负载均衡 2 scope权限获取不到
 *
 * @author lizhifu
 * @since 2023/4/5
 */
